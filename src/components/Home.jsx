...
const Home = () => {
  ...
  return (
    <div className='w-screen font-montserrat overflow-hidden'>
        ...
        <div className='relative w-full h-72 sm:h-[25rem] lg:h-[50rem] font-montserrat text-white px-4 md:pr-4 flex flex-col justify-center pt-4 overflow-y-auto'>
        ...
        <div className='h-[70vh] md:h-[80vh] max-ss:pt-10 font-montserrat flex flex-col sm:flex-wrap'>
          <div className='w-full sm:w-1/2 h-1/2 sm:h-full flex flex-col justify-end'>

            {/* message from the therapist */}
            <div className='w-full h-3/4 flex flex-col justify-end pt-4 space-y-3 px-4 md:pr-4 text-center text-secondary'>
          ...
          <div className='w-full sm:w-1/2 h-1/2 sm:h-full  flex flex-col items-center justify-end space-y-3 px-4 lg:pr-4 text-center text-secondary'>
            <div className = 'w-full h-3/4 flex flex-col justify-center pt-4 space-y-3 px-4 md:pr-4 text-center text-secondary'>
        ...
        <img src={footer} className='absolute w-full md:h-screen' />
        <div className='w-full h-44 sm:h-[35vh] md:h-screen relative font-montserrat flex items-end pt-12 sm:pt-12'>
          ...
          <ul className='w-1/3 list-none text-[10px] sm:text-[24px] cursor-pointer indent-5 sm:indent-16 pb-4 sm:pb-10'>
            ...
            <div className='w-2/3 h-full font-montserrat text-white space-y-2 p-3 md:p-0 flex flex-col justify-center sm:justify-end sm:pb-10 items-center'>
              ...
              <p className='text-[10px] sm:text-[20px] text-center italic max-sm:px-6 md:w-1/3'>Every child is different, let's help them grow how they are!</p>
            </div>
        </div>
    </div>
  )
