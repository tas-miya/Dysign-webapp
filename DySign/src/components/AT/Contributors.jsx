...
const Contributors = () => {
  return (
    <div className='w-screen'>
        ...
        <div className='h-[100px] flex pr-5 pl-5 justify-around items-center'>
        ...
        <div className='w-screen h-[80px] flex justify-center items-center'>
         ...
         {/* FAQs and Signs */}
        <div className='h-[300px] flex-wrap text-almond font-roboto flex justify-center items-center pt-5'>
        ...
        {/* Footer */}
        <div className='w-full h-[100px] font-roboto flex items-center'>
