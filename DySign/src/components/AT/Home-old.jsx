...
import {CIC, TMC, READ, bg} from '../assets'
...
const Home = () => {
  ...
  return (
    <div className=''>
      <img src = {bg} alt = "background" className='absolute object-fill w-screen' />

        <Navbar />
        <Hero />
        {/* <Contributors /> */}
        
        <div className='h-[120px] flex pr-5 pl-5 justify-around items-center relative'>
        ...
        <div className='relative'>
         ...
         {/* FAQs and Signs */}
        <div className='h-[320px] relative flex-wrap text-almond font-roboto flex justify-center items-center pt-10'>
          ...
          {/* button */}
          <div className='w-screen h-[60px] flex justify-center items-center'>
        ...
        {/* About us */}
        <div className='h-[220px] relative flex flex-wrap pt-4'>
          ...
          <div className='w-full h-1/2 flex flex-wrap justify-center font-roboto items-center'>
        ...
        {/* Footer */}
        <div className='w-full h-[100px] relative font-roboto flex items-center pb-4'>
          ...
          <ul className='w-1/3 list-none  text-[10px] cursor-pointer indent-5'>
            ...
            <div className='w-2/3 h-full font-roboto text-almond space-y-1 p-3 flex flex-col justify-center'>
